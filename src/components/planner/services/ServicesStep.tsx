...
import { SURPRISE_GIFTS, detailsFor, type ServiceOption } from '@/data/services';
...
/**
 * A category's package tiles in one grid, with single-select filter pills
 * above when more than one category is shown.
 */
